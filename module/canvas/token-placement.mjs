 ...
 * @property {foundry.documents.TokenDocument} [origin] - Token that is the origin point of the placement.
 * @property {foundry.data.PrototypeToken[]} tokens - Prototype token information for rendering.
 */
 ...
 * @property {foundry.data.PrototypeToken} prototypeToken
 ...
 * @property {number} x - The x-coordinate of the top-left corner of the Token
 * @property {number} y - The y-coordinate of the top-left corner of the Token
 * @property {number} elevation - The vertical elevation of the Token, in distance units
 * @property {number} rotation - The rotation of the Token in degrees, from 0 to 360. A value of 0 represents a southward-facing Token.
 */
 ...
 * This class is take it form DnD5e system... <3
 */
export default class TokenPlacement {
  ...
  static adjustAppendedNumber(tokenDocument, placement) {
    ...
    if (tokenDocument instanceof foundry.documents.TokenDocument)
